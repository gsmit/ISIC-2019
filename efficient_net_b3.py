...
class_unk = np.where(class_max < 0.3, 1.0, 0.0)
...
submission.to_csv(str(submission_path) + f'\\efficient-net-{model_name}-baseline-{version}-post-processing.csv', index=False)
