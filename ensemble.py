...
# combine submissions
submission = efn_b3_v1_augment + efn_b3_v2_augment + efn_b3_v3_augment + efn_b3_v4_subset + efn_b4_v1_subset
submission = submission / 3

# save new submission
submission.to_csv('D:/Data/ISIC-2019/submissions/ensemble-v6-augment.csv', index=True)
