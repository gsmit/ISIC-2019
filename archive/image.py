...
for skin_class in classes:
    ...
    try:
        os.mkdir(f'D:/Data/ISIC-2019/images_train/{skin_class}')
    ...
    for img_path in subset['path'].tolist():
        ...
        shutil.copyfile(img_path, f'D:/Data/ISIC-2019/images_train/{skin_class}/{img_name}')
...
#%%
data = pd.read_csv('D:/Data/ISIC-2019/external/PH2Dataset/PH2_dataset.txt', sep=",")
